...
public class IOStreamDemo 
{
	...
	{
		// file path: H:\Data\Original_Data\EIS
		String filePath = "H:\\Data\\Original_Data\\EIS\\20170415-EIS-2-1.DTA";
		try 
		{
			...
			try 
			{
				DataOutputStream out2 = new DataOutputStream(new BufferedOutputStream(new FileOutputStream("H:\\Data.txt")));
				out2.writeBytes("Here's the value of pi: \n");
				out2.writeDouble(3.14159);
				out2.close();
				DataInputStream in5 = new DataInputStream(new BufferedInputStream(new FileInputStream("H:\\Data.txt")));
